...
function getStudentsByID(currStudents) {
  const globalStudents = students.slice();
  students = currStudents.slice();
...
console.log("testing: getStudentsByName");
...
console.log("testing: getStudentsByID");
...
console.log("testing: global students not modified");
